    ...
    <div class="col mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">Create a list of potential improvements with impact level (high, moderate, low). </br></br></br></br>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="col mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">After the Verify stage, you will reenter continuous improvement with newly gathered information....</br></br>
                </p>
            </div>
        </div>
    </div>
