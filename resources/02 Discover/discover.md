...
<div class="grid">
  <a href="https://google.com" class="card"><i class="fa-solid fa-building-columns"></i> Example 1</a>
  <a href="https://google.com" class="card">Example 2</a>
  <a href="https://google.com" class="card">Example 3</a>
</div>
...
<div class="row">
    <div class="col-sm-4">
        <div class="card" >
        <img class="card-img-top" src="https://placehold.co/50x50" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content. <i class="fa-brands fa-html5"></i></p>
...
<div class="row">
  <div class="col-sm-4">
    <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
      <div class="card-header"><i class="fa-brands fa-html5"></i> Header</div>
      <div class="card-body">
